...
class Simulator(object):
    ...
    def save_result(self, path_name, suffix=None, unique_name=True):
        ...
        with open(os.path.join(path_name, f'passenger_queue{suffix}.pickle'), 'wb') as pickle_file:
            pickle.dump(saved_q_length, pickle_file)

        with open(os.path.join(path_name, f'vehicle_queue{suffix}.pickle'), 'wb') as pickle_file:
            pickle.dump(saved_v_length, pickle_file)

        with open(os.path.join(path_name, f'wait_time{suffix}.pickle'), 'wb') as pickle_file:
